...
ggplot(CrossProf) +
       ...
       xlim(100,500) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1225,1250) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
